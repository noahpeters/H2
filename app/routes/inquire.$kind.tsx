  ...
  return (
    <main className={`studio-page ad-page ad-${kind}`}>
      ...
      <div className="ad-layout">
        ...
        <section
          className="ad-inquiry ad-inquiry-primary"
          id="inquiry"
        ...
        <div className="ad-story">
          ...
          <section className="ad-next ad-story-next">
        ...
        <section
          className="ad-inquiry ad-inquiry-repeat"
          id="inquiry-bottom"
          aria-labelledby="inquiry-bottom-title"
        >
          <div>
            <p className="eyebrow">A place to begin</p>
            <h2 id="inquiry-bottom-title">{page.formTitle}</h2>
            <p>{page.formIntro}</p>
          </div>
          {form}
        </section>
